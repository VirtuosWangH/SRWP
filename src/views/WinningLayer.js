...
var WinningLayer = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        this.init();
        cc.SpriteFrameCache.getInstance().addSpriteFrames(res.textureAssets01_plist,res.textureAssets01_png);
    },
    init:function(){
        this._super();
        this.symbolGrad = [];
        ...
        for (var i = 0; i<this.winSymbols.length; i++) {
            ...
            for (var j = 0; j<5; j++) {
                ...
                var tempSprite;
                if(index!==7){
                    tempSprite = cc.Sprite.createWithSpriteFrameName("Symbol_0"+index+".png");
                }else{
