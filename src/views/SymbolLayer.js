                    ...
                    tempSymbol.setPositionY(605 - offset);
                      if(this.rollDown){
                          if(i<5 && j<4){
                              ...
                              var frame = cc.SpriteFrameCache.getInstance().getSpriteFrame("Symbol_0"+index+".png");
                              tempSymbol.setDisplayFrame(frame);
                          }
                      }else{
                          var frame = cc.SpriteFrameCache.getInstance().getSpriteFrame(this.getRandonSymbolName());
                          tempSymbol.setDisplayFrame(frame);
                      }
                }
            }
